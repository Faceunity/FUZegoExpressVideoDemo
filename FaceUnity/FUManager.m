...
- (CVPixelBufferRef)renderItemsToPixelBuffer:(CVPixelBufferRef)pixelBuffer{
    ...
    if (_isRender) {
        ...
        CVPixelBufferRef buffer = [[FURenderer shareRenderer] renderPixelBuffer:pixelBuffer withFrameId:frameID items:readerItems itemCount:2 flipx:_flipx customSize:CGSizeZero useAlpha:NO];//flipx 参数设为YES可以使道具做水平方向的镜像翻转
        frameID += 1;
