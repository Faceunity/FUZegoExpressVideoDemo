...
@interface ZGVideoForMultipleUsersPopupView ()<UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (weak, nonatomic) IBOutlet UILabel *titleLabel;
@property (strong, nonatomic) NSArray<NSString *>* textList;
@end

@implementation ZGVideoForMultipleUsersPopupView
...
+ (ZGVideoForMultipleUsersPopupView*)show {
    ZGVideoForMultipleUsersPopupView* popupView = [[[NSBundle mainBundle] loadNibNamed:@"ZGVideoForMultipleUsersPopupView" owner:self options:nil] objectAtIndex:0];
