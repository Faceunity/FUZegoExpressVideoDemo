...
- (IBAction)onTrafficControllSwitchChanged:(UISwitch *)sender {
    ...
    [self appendLog:[NSString stringWithFormat:@"📥 OnTrafficControllSwitchChanged %d", sender.isOn]];
}
...
- (IBAction)onTrafficControllMinVideoBitrateChanged:(UISlider *)sender {
    ...
    [self appendLog:[NSString stringWithFormat:@"📥 OnTrafficControllMinVideoBitrateChanged %f", self.minVideoBitrateForTrafficControl]];
...
- (IBAction)onTrafficControllMinVideoModeChanged:(UISegmentedControl *)sender {
    ...
    [self appendLog:[NSString stringWithFormat:@"📥 OnTrafficControllMinVideoModeChanged %@", sender.selectedSegmentIndex == 0 ? @"NoVideo" : @"UltraLowFPS"]];
