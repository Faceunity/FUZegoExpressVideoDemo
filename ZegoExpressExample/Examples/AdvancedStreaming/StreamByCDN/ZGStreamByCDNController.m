...
#import "ZGStreamByCDNController.h"
#import "ZGStreamDirectCDNController.h"
#import "KeyCenter.h"
#import "ZGUserIDHelper.h"
#import <ZegoExpressEngine/ZegoExpressEngine.h>
@interface ZGStreamByCDNController ()<ZegoEventHandler>
...
@implementation ZGStreamByCDNController
...
- (IBAction)onAddCDNURLButtonTapped:(UIButton *)sender {
    [[ZegoExpressEngine sharedEngine] addPublishCdnUrl:self.publishCDNURLTextField.text streamID:self.streamID callback:^(int errorCode) {
...
- (IBAction)onPushDirectCDNButtonTapped:(id)sender {
    [[ZegoExpressEngine sharedEngine] stopPublishingStream];
    [[ZegoExpressEngine sharedEngine] stopPlayingStream:self.streamID];
    
    ZGStreamDirectCDNController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"StreamDirectCDN"];
