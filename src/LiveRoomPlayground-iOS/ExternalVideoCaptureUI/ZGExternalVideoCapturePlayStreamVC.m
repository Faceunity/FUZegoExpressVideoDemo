//
//  ZGExternalVideoCapturePlayStreamVC.m
...
@interface ZGExternalVideoCapturePlayStreamVC () <ZegoLivePlayerDelegate>

@property (nonatomic) ZegoLiveRoomApi *zegoApi;

@end

@implementation ZGExternalVideoCapturePlayStreamVC

+ (instancetype)instanceFromStoryboard {
    return [[UIStoryboard storyboardWithName:@"VideoExternalCapture" bundle:nil] instantiateViewControllerWithIdentifier:NSStringFromClass([ZGExternalVideoCapturePlayStreamVC class])];
}
